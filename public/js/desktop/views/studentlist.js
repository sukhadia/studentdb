define (['jquery', 
    'desktop/views/studentlistitem', 'common/views/studentlistbase', 'text!desktop/tpl/StudentListView.html'],
    function($, StudentListItemView, StudentListViewBase, template) {
        return StudentListViewBase.extend({
            ...
            render: function () {
                return StudentListViewBase.prototype.renderCommon.call(this, '.tablebody', StudentListItemView, template);
            },
